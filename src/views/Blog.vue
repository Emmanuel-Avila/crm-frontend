...
function onSubmit(values, { resetForm }) {
  ...
  axios.post(`${import.meta.env.VITE_SERVER}/blog`, values, {
    headers: {
    ...
    .then(function (response) {
      ...
      Swal.fire({
        icon: 'success',
        text: "Se creó la entrada de blog correctamente"
      })
      resetForm();
      console.log(data);
    })
            ...
            <Form @submit='onSubmit' :validation-schema="schema" v-slot="{ values }">
              <div class="card">
                <div class="card-body p-4">
                  <h5 class="mb-4">Formulario para Blogs</h5>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <Field name='category' class="form-select" id="select" placeholder="Ingresa el título" as="select">
                        ...
                        <option value="bells">Campaña</option>
                      </Field>
