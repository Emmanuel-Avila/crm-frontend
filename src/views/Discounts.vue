...
const schema = yup.object({
  ...
  body: yup.string("No olvide el cuerpo").required("Cuerpo del Descuento requerido"),
  ...
  webpage: yup.string().required("Pagina web requerido"),
  question: yup.string().required("Pregunta requerido"),
...
function onSubmit(values, { resetForm }) {
  ...
  console.log(values)
  axios.post(`${import.meta.env.VITE_SERVER}/discount`, values, {
    headers: {
    ...
    .then(function (response) {
      ...
      Swal.fire({
        icon: 'success',
        text: "Se creó la entrada de Descuento correctamente"
      })
      resetForm();
      console.log(data);
    })
          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Crear Descuento</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <Form @submit='onSubmit' :validation-schema="schema" v-slot="{ values }">
              <div class="card">
                <div class="card-body p-4">
                  <h5 class="mb-4">Formulario para Descuentos</h5>
                  <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label">Título</label>
                    <div class="col-sm-9">
                      <Field name='title' type="text" class="form-control" id="input35" placeholder="Ingresa el título">
                      </Field>
                      <ErrorMessage class="red" name="title" />
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label">Categoría</label>
                    <div class="col-sm-9">
                      <Field name='category' class="form-select" id="select" placeholder="Ingresa el título" as="select">
                        <option value="">Seleccione la categoría</option>
                        <option value="education">Educacion</option>
                        <option value="turism">Turismo</option>
                        <option value="health">Salud</option>
                        <option value="fashion">Moda y Belleza</option>
                        <option value="transport">Transporte</option>
                      </Field>
                      <ErrorMessage class="red" name="category" />
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="input40" class="col-sm-3 col-form-label">Fecha</label>
                    <div class="col-sm-9">
                      <Field type="hidden" name='date' v-model='date' />
                      <VueDatePicker v-model="date" locale="es"></VueDatePicker>
                      <ErrorMessage class="red" name="date" />
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label">Locacion</label>
                    <div class="col-sm-9">
                      <Field name='location' type="text" class="form-control" id="input35"
                        placeholder="Ingresa locacion para el beneficio">
                      </Field>
                      <ErrorMessage class="red" name="location" />
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label">Telefono</label>
                    <div class="col-sm-9">
                      <Field name='phone' type="text" class="form-control" id="phone"
                        placeholder="Ingresa telefono de contacto para el beneficio">
                      </Field>
                      <ErrorMessage class="red" name="phone" />
                    </div>
                  </div>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <Field name='email' type="text" class="form-control" id="email"
                        placeholder="Ingresa email de contacto para el beneficio">
                      </Field>
                      <ErrorMessage class="red" name="email" />
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="webpage" class="col-sm-3 col-form-label">Pagina web</label>
                    <div class="col-sm-9">
                      <Field name='webpage' type="text" class="form-control" id="webpage"
                        placeholder="Ingresa la pagina web de contacto para el beneficio">
                      </Field>
                      <ErrorMessage class="red" name="webpage" />
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="question" class="col-sm-3 col-form-label">Preguntas del Cliente</label>
                    <div class="col-sm-9">
                      <Field name='question' type="text" class="form-control" id="question"
                        placeholder="Ingresa que contactar si tiene preguntas acerca del beneficio">
                      </Field>
                      <ErrorMessage class="red" name="question" />
                    </div>
                  </div>
                  <div class="row mb-3">
