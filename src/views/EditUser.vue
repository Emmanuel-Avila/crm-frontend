...
function updateState() {
  ...
  console.log(data)
  axios.post(`${import.meta.env.VITE_SERVER}/users/update`, data, {
    headers: {
              ...
              <div class="card-body p-4">
                ...
                <form class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" :value="userData.name" class="form-control" name="name" id="input4">
                  </div>
                  <div class="col-md-6">
                    <label for="input4" class="form-label">Apellido</label>
                    <input type="text" :value="userData.surname" class="form-control" name="surname" id="surname">
                  </div>
                  <div class="col-md-12">
                    <label for="child" class="form-label">Nueva Contraseña</label>
