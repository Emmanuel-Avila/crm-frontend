...
onMounted(() => {
  axios.get(`${import.meta.env.VITE_SERVER}/social`, {
    headers: {
...
function onSubmit(values) {
  ...
  axios.post(`${import.meta.env.VITE_SERVER}/social`, data, {
    headers: {
      "Content-Type": "application/json",
      "Authorization": `Bearer ${localStorage.getItem("token")}`
    }
    ...
    .then(function (response) {
      ...
      Swal.fire({
        icon: 'success',
        text: "Se edito la prevision social correctamente"
      })
      console.log(data);
    })
    .catch(function (error) {
          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Editar prevision social</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <Form @submit='onSubmit' :validation-schema="schema" v-slot="{ values }">
              <div class="card">
                <div class="card-body p-4">
                  <h5 class="mb-4">Formulario para prevision social</h5>
                  <div class="row mb-3">
