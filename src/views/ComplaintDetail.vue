              ...
              <div class="card-body p-4">
                ...
                <form class="row g-3">
                  ...
                  <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" id="input5" :value="complaint.guardianNames +
                      ' ' +
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="document" :value="complaint.documentType + ' - ' + complaint.documentValue
                      " disabled />
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <div>
                      <a v-for="(docu, index) in complaint.documents" :key="index" :href="docu" target="_blank">{{ docu
                      }}</a>
                    </div>
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                      <button type="button" class="btn button-primary px-4" @click="updateState">
                        Guardar
                      </button>
                    </div>
                  </div>
                ...
                <form class="row g-3">
                  <div class="col-md-12">
                    ...
                    <select id="input19" class="form-select" v-model="response">
                      ...
                      <option v-for="(resp, index) in responses" :key="resp._id" :value="resp.text">
                        {{ "Respuesta " + (index + 1) }}
                      </option>
                    </select>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                      <button type="button" class="btn button-primary px-4" @click="sendResponse">
                        Enviar
                      </button>
                    </div>
                  </div>
