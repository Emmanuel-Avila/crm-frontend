  ...
  <div class="offcanvas offcanvas-start w-260" data-bs-scroll="true" tabindex="-1" id="offcanvasPrimaryMenu">
    ...
    <div class="offcanvas-body">
      <nav class="sidebar-nav">
        <ul class="metismenu" id="sidenav" v-if="userData.type === 'COMP'">
          <li>
        ...
        <ul class="metismenu" id="sidenav" v-if="userData.type === 'CRM'">
          <li>
            <a href="javascript:;" class="has-arrow">
              <div class="parent-icon"><i class="material-icons-outlined">home</i>
              </div>
            ...
            <ul>
              <li><router-link :to="{ name: 'landing' }"><i class="material-icons-outlined">arrow_right</i>Editar Imagenes
                  de Home</router-link>
              </li>
              <li><router-link :to="{ name: 'blog' }"><i class="material-icons-outlined">arrow_right</i>Crear entrada de
                  Blog</router-link>
              </li>
              <li><router-link :to="{ name: 'products' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Productos</router-link>
              </li>
              <li><router-link :to="{ name: 'us' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Nosotros</router-link>
              </li>
              <li><router-link :to="{ name: 'digital-services' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Servicios Digitales</router-link>
              </li>
              <li><router-link :to="{ name: 'accounts' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Cuentas Recaudo</router-link>
              </li>
              <li><router-link :to="{ name: 'health-campaign' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Campaña de Salud</router-link>
              </li>
              <li><router-link :to="{ name: 'social-prevision' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Prevision Social</router-link>
              </li>
              <li><router-link :to="{ name: 'training' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Capacitaciones</router-link>
              </li>
              <li><router-link :to="{ name: 'events' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Eventos</router-link>
              </li>
              <li><router-link :to="{ name: 'fair' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Feria</router-link>
              </li>
              <li><router-link :to="{ name: 'discounts' }"><i class="material-icons-outlined">arrow_right</i>Crear
                  Descuento Institucional</router-link>
              </li>
              <li><router-link :to="{ name: 'covenants' }"><i class="material-icons-outlined">arrow_right</i>Crear
                  Convenio Comercial</router-link>
              </li>
              <li><router-link :to="{ name: 'transparency' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Transparencia</router-link>
              </li>
              <li><router-link :to="{ name: 'elections' }"><i class="material-icons-outlined">arrow_right</i>Editar
                  Elecciones</router-link>
              </li>
            </ul>
          </li>
        </ul>
        <!-- <ul class="metismenu" id="sidenav">
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="ecommerce-customer-details.html"><i class="material-icons-outlined">arrow_right</i>Order
                  Details</a>
              </li>
            </ul>
          </li>
